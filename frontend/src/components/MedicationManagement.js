...
const MedicationManagement = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 text-gray-900">
            ...
            {/* Main Content */}
            <div className="flex-grow pt-16 px-4 py-8">
                <div className="container mx-auto">
                    {/* Added extra top margin to move the title down */}
                    <h1 className="text-3xl font-bold mb-6 mt-8 text-center">Medication Management</h1>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="shadow appearance-none border border-gray-300 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
